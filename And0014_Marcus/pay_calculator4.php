...
if ($rec_present) {
    ...
    <div class="col-lg-2">
        ...
        <button id="btn_calculate_pay" name="btn_calculate_pay" type="button"
                style="width: 100%"
                class="btn btn-outline-info  mb-3 delete_shift">
            Calculate pay
        </button>
    ...
    <tr>
        ...
        <th class="table-dark" scope="col">config</th>
    ...
    if ($result) {
        ...
        <a type="button" title="Delete" style="color:#0099cc;font-size:20px;padding-right:8px;">
        <i class="fa fa-trash" aria-hidden="true"></i>
        </a>
        <a type="button" title="Edit" style="color:#0099cc;font-size:20px;">
